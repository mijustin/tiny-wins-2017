...
class MC4WP_Ecommerce {
	...
	*/
	public function update_store( array $args ) {
		...
		$store_id = $this->store_id;
		$args['id'] = $store_id;
		$args['platform'] = 'WooCommerce';
		$args['domain'] = parse_url( get_home_url(), PHP_URL_HOST );
		$args['email_address'] = get_option( 'admin_email' );
		$args['primary_locale'] = substr( get_locale(), 0, 2 );
